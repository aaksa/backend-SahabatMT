...
<div class="row">
  <div class="col-lg-7 col-xl-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-2">
          <h6 class="card-title mb-0">Request Penjualan Customer</h6>
          <div class="dropdown mb-2">
            <button class="btn p-0" type="button" id="dropdownMenuButton7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
              <a class="dropdown-item d-flex align-items-center" href="/request"><i data-feather="eye" class="icon-sm mr-2"></i> <span class="">View</span></a>
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            <thead>
              <tr>
                <th class="pt-3">#</th>
                <th class="pt-3">Nama Barang</th>
                <th class="pt-3">Tanggal Request</th>
                <th class="pt-3">Nomor Hp</th>
            ...
            @foreach ($data as $req)
                <tr>
                  ...
                  {{-- <td >
                    <span class="badge {{ $req->kondisi === 'baru' ? 'badge-success' : 'badge-info-muted' }}">
                        {{ $req->kondisi }}
                    </span> --}}
                <td>0{{ $req->user->nomor_hp }}</td>
                </td>
                  <td>{{ $req->user->nama }}</td>
