<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['produk/*']) }}">
        <a class="nav-link" data-toggle="collapse" href="#produk" role="button" aria-expanded="{{ is_active_route(['produk/*']) }}" aria-controls="produk">
          <i class="link-icon" data-feather="codesandbox"></i>
          <span class="link-title">Produk</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>

        <div class="collapse {{ show_class(['produk/*']) }}" id="produk">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('produk/barang') }}" class="nav-link {{ active_class(['produk/barang']) }}">Barang</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('produk/jasa') }}" class="nav-link {{ active_class(['produk/jasa']) }}">Jasa</a>
            </li>
          </ul>
        </div>
        </li>
      ...
      <li class="nav-item">
        {{-- <a href="https://www.nobleui.com/laravel/documentation/docs.html" target="_blank" class="nav-link"> --}}
          <a href="{{ url('/request') }}" class="nav-link {{ active_class(['/request']) }}">
